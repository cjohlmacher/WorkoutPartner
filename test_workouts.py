...
class WorkoutViewTestCase(TestCase):
    ...
    def setUp(self):
        ...
        for workout_activity in [workout_activity_1, workout_activity_2, workout_activity_3]:
    ...
    def test_show_workouts(self):
        """Can any user view recent public workouts? """
    ...
    def test_hide_private_workouts(self):
        """ Are recent private workouts hidden from the user? """
        with self.client as c:
            testuser1 = User.query.filter_by(username="testuser1").first()
            with c.session_transaction() as sess:
                sess[USER_KEY] = testuser1.id
